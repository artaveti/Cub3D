...
int	main(int argc, char *argv[])
{
	...
	if (game.mlx == NULL)
		exit(EXIT_FAILURE);
	game.mlx_win = mlx_new_window(game.mlx, SIZE_WIDTH_WINDOW_X, SIZE_HIGH_WINDOW_Y,
		"./cub3D");
	if (game.mlx_win == NULL)
		exit(EXIT_FAILURE);

printf("(%d)\n", mlx_pixel_put(game.mlx, game.mlx_win, 100, 100, 0x00556633));
...
// {
// 	j = 0;
// 	while (j <= SIZE_HIGH_WINDOW_Y / 2)
// 	{
// 		printf("(%d)\n", mlx_pixel_put(game.mlx, game.mlx_win, i, j, 0x00000033));
// 		j++;
// 	}
// 	i++;
// }
